      ...
      {loading ? (
        ...
        <div className="space-y-3">
          ...
          {pendingList.map(({ charge, subscription }) => (
            <div
              key={charge.id}
              className="bg-amber-50 border border-amber-200 rounded-xl px-6 py-4 flex items-center gap-4"
            >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white px-5 py-3 rounded-lg font-bold text-sm transition-all disabled:opacity-60 shadow-sm min-w-[160px] justify-center"
              >
